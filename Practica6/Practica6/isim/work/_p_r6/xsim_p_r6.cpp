#include "isim/work/_p_r6/_p_r6.h"
...
public:
    ...
    HSimConfigDecl * topModuleInstantiate() {
        ...
        (*cfgvh).addVlogModule("PR6", (HSimInstFactoryPtr)IF0);
